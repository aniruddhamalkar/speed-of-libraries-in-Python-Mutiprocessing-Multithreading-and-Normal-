...
if __name__ == "__main__":
    ...
    process1 = threading.Thread(target=num_calc, args=(number1, number2, ))
    process2 = threading.Thread(target=no_square, args=(number1, ))
    process3 = threading.Thread(target=no_qube, args=(number1,))
